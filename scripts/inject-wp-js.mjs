...
const BLOCKS = [
  ...
  // ADRAIL 과 같은 이유로 광고 블록 묶음 안에 둔다 — 계측(MG-ADOBS)보다 앞이어야
  // 최종 위치를 관찰한다. 데스크톱 상단 728x90 을 첫 화면 안으로 올린다.
  { marker: 'MG-ADTOP', file: 'wp-ad-top.js', desc: '데스크톱 상단 728x90 을 대표이미지 위로 이동(첫 화면 안)' },
