...
로그라이크(로그라이트)는 2026년에도 스팀 인디의 핵심 트렌드다. 실제로 **2025년 화제가 된 국산 인디게임 상위작 상당수가 '로그라이크' 요소를 포함**했다. 반복 플레이·랜덤성·빌드 조합이라는 문법이 짧은 개발 리소스로도 높은 리플레이성을 만들어내기 때문이다. 1인~소규모팀에게 특히 리소스 효율이 좋다.

핵심은 '또 하나의 로그라이크'가 아니라 **문법을 비트는 응용**이다. 덱빌딩·타워디펜스·경영 시뮬레이션 등 다른 장르와 결합할 때 신선함이 나온다.

## 프리미엄 서바이버라이크: 새 장르의 탄생

2026년 가장 주목할 흐름은 **'프리미엄 서바이버라이크'**라는 새 장르명의 등장이다. 소울라이크의 묵직한 액션성과, 몰려오는 적을 쓸어담는 서바이버라이크(뱀서류)의 쾌감을 결합한 형태다. 무료·캐주얼로 소비되던 서바이버라이크를 **정가 판매가 가능한 완성도 높은 경험**으로 끌어올린 것이 핵심이다.

<div class="chart-bar" data-title="2026 인디 주목 장르의 개발 효율 대비 관심도 (개념적 평가, 10점)" data-labels="로그라이크,프리미엄 서바이버라이크,코지/힐링,덱빌더,소울라이크" data-values="9,9,7,8,6" data-colors="#3b82f6,#10b981,#f59e0b,#ef4444,#8b5cf6" data-unit="점"></div>

## 하이브리드가 표준이 되다

2026년 시장의 뚜렷한 흐름은 **장르 다변화와 결합**이다. 익숙한 공식을 반복하기보다 장르 내부 문법을 비틀어 새로운 체험을 제시하려는 시도가 강해지고 있다.
...
또한 **인디 퍼블리셔가 발굴하는 AA급 타이틀**과 셀프 퍼블리싱 인디의 존재감이 함께 커지고 있다. 규모보다 '분명한 핵심 설계'를 내세운 게임이 주목받는다.
