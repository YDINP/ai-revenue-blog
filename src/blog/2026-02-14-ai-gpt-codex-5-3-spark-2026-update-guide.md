...
반면 Spark는 풀 모델의 추론력을 의도적으로 축소하는 대신, Cerebras의 전용 칩 위에서 <span style="font-size:1.3em;font-weight:800">15배의 속도</span>를 얻었습니다. Terminal-Bench 격차(77.3% vs 58.4%)가 이를 명확히 보여줍니다 — 복잡한 멀티스텝 작업에서는 풀 모델이 월등하지만, 단순 코드 생성에서는 Spark가 같은 작업을 5~8배 빨리 끝냅니다.
