...
<div class="chart-bar" data-title="코드 서명이 자동화 최대 난관 (참고용, 높을수록 까다로움)" data-labels="빌드(xcodebuild),아카이브,코드 서명,스토어 업로드" data-values="3,5,9,6" data-colors="#3b82f6,#009e73,#d55e00,#f59e0b" data-unit="점"></div>
