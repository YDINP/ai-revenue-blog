---
title: "인디게임 첫 출시 매출의 현실 2026: 중앙값·위시리스트 전환율 실데이터"
description: "첫 인디게임은 실제로 얼마를 벌까? 2026년 스팀 판매 중앙값, 위시리스트-판매 전환율, 첫 게임 평균 매출까지 실제 데이터로 파헤칩니다. 환상 대신 숫자를 확인하세요."
pubDate: 2026-07-11
author: "TechFlow"
category: "Game"
tags: ["인디게임", "게임 수익화", "스팀", "위시리스트", "게임 매출"]
image:
  url: "https://images.pexels.com/photos/3945683/pexels-photo-3945683.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
  alt: "Person analyzing sales data charts on a computer screen."
coupangLinks:
...
faq:
  ...
  - q: "위시리스트는 판매로 얼마나 이어지나요?"
    a: "중앙값 기준 출시 첫날 약 5%, 첫 주 약 20%, 첫 해 약 60%가 구매로 전환된다. 즉 출시 시점 위시리스트 10만 개면 첫 주 약 1.5만 장이 현실적 기대치다. 가격이 10달러를 넘으면 전환율은 더 낮아진다."
  - q: "몇 개의 위시리스트가 있어야 '먹고살' 수 있나요?"
    a: "5,000개 미만이면 첫 달 매출이 1.5만 달러를 넘기 어렵고, 25,000~50,000개 구간이면 첫 달 10만~25만 달러가 기대된다. 출시 전 최소 1만~2만 위시리스트를 목표로 삼고, 넥스트페스트·데모로 이를 쌓는 것이 현실적인 손익분기 전략이다."
---

"첫 게임으로 인생 역전"은 유튜브 썸네일에나 있는 이야기다. 2026년 스팀의 **실제 매출 데이터**는 훨씬 냉정하다. 이 글은 감상 대신 숫자로, 첫 인디게임이 실제로 얼마를 버는지, 위시리스트가 판매로 어떻게 이어지는지 정리한다. (관련: [2026년 인디게임 수익화 현실](/blog/2026-02-26-game-2026-indie-game-monetization-reality-5-truths/))

## 중앙값 vs 평균: 착시부터 걷어내자

가장 먼저 깨야 할 환상은 "평균"이다. 데뷔작 평균 매출은 약 **12만 달러**로 집계되지만, 이는 소수의 초대박작이 끌어올린 수치다. 실제 **중앙값(딱 가운데 게임)의 생애 총매출은 약 5,000~15,000달러**, 여기서 밸브의 30% 수수료를 빼면 개발자 몫은 3,500~10,500달러에 불과하다.
...
평균은 "가능성"을, 중앙값은 "확률"을 말한다. 사업 계획은 반드시 **중앙값 기준**으로 세워야 한다.
...
<div class="chart-bar" data-title="위시리스트 → 구매 전환율 (중앙값, 기간별)" data-labels="출시 첫날,첫 주,첫 해" data-values="5,20,60" data-colors="#3b82f6,#10b981,#f59e0b" data-unit="%"></div>

즉 **출시 첫날에 팔리는 건 위시리스트의 5% 안팎**이고, 나머지는 세일·업데이트를 거쳐 1년에 걸쳐 천천히 전환된다. 출시일 매출만 보고 실망할 필요가 없다는 뜻이자, 반대로 "출시 대박"은 확률이 낮다는 뜻이다.
