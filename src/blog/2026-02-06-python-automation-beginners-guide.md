...
<div class="chart-bar" data-orient="vertical" data-title="예제별 소요 시간 (분)" data-labels="파일명 변경,스케줄 실행,Excel 처리,이메일 발송,웹 스크래핑" data-values="5,10,10,15,20" data-colors="#10b981,#10b981,#f59e0b,#3b82f6,#8b5cf6" data-unit="분"></div>
