---
title: "Python 자동화 5분 완성: 실무 예제 5가지"
description: "파이썬으로 파일 정리, 데이터 복사, 이메일 발송 같은 반복 업무를 자동화하는 5가지 실전 예제를 코드와 함께 보여줍니다. 비개발자도 따라 하며 클릭 100번을 코드 10줄로 줄이는 법을 배워보세요."
pubDate: 2026-02-06
category: "Dev"
...
<div class="chart-radar" data-title="Excel·스케줄 자동화가 난이도 대비 효과 최고" data-items='[{"name":"파일/이메일 자동화","scores":[{"label":"난이도","value":3,"color":"#009e73"},{"label":"시간절약","value":7,"color":"#009e73"},{"label":"범용성","value":9,"color":"#009e73"},{"label":"학습가치","value":6,"color":"#009e73"},{"label":"실무적용","value":9,"color":"#009e73"}]},{"name":"웹 스크래핑","scores":[{"label":"난이도","value":7,"color":"#3b82f6"},{"label":"시간절약","value":9,"color":"#3b82f6"},{"label":"범용성","value":7,"color":"#3b82f6"},{"label":"학습가치","value":9,"color":"#3b82f6"},{"label":"실무적용","value":8,"color":"#3b82f6"}]},{"name":"Excel/스케줄 자동화","scores":[{"label":"난이도","value":4,"color":"#f59e0b"},{"label":"시간절약","value":10,"color":"#f59e0b"},{"label":"범용성","value":8,"color":"#f59e0b"},{"label":"학습가치","value":7,"color":"#f59e0b"},{"label":"실무적용","value":10,"color":"#f59e0b"}]}]'></div>

<div class="chart-bar" data-orient="vertical" data-highlight="max" data-title="웹 스크래핑이 가장 오래 걸리는 작업 (분)" data-labels="파일명 변경,스케줄 실행,Excel 처리,이메일 발송,웹 스크래핑" data-values="5,10,10,15,20" data-colors="#009e73,#009e73,#f59e0b,#3b82f6,#8b5cf6" data-unit="분"></div>
...
### 해설
`Path.glob()`으로 확장자별 파일을 필터링하고, `enumerate()`로 일련번호를 붙입니다. `{index:03d}`는 001, 002처럼 3자리 숫자로 포맷팅하는 문법입니다. 이 Python 자동화 스크립트 하나로 1000개 파일도 <span style="font-size:1.3em;font-weight:800">5초</span> 안에 처리됩니다.

## 2. 이메일 자동 발송 - 단체 공지 보내기

### 문제 상황
팀원 50명에게 같은 내용의 월간 리포트를 Gmail로 발송해야 합니다. 수동으로 보내면 30분 걸리지만, 파이썬 업무자동화로 <span style="font-size:1.15em;font-weight:700">1분</span> 안에 해결합니다.
