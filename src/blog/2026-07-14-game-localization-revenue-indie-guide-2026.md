...
<div class="chart-bar" data-orient="vertical" data-title="현지화 투자 대비 추가매출 최대 33배 (인디 사례, 참고용)" data-labels="투자(최소),투자(최대),추가매출(최소),추가매출(최대)" data-values="12,25,120,400" data-colors="#f59e0b,#f59e0b,#009e73,#009e73" data-unit="k$"></div>
