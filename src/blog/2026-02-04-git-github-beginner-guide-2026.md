...
description: "Git과 GitHub를 처음 배우는 분을 위한 2026년 입문 가이드입니다. 설치와 초기 설정부터 저장소 생성, 첫 커밋, GitHub 업로드까지 10분 만에 차근차근 따라 할 수 있도록 정리했습니다."
pubDate: 2026-02-04
category: "Dev"
...
쉽게 말해, Git은 도구이고 GitHub는 그 도구로 만든 작업물을 저장하고 공유하는 플랫폼입니다.
...
커밋(commit)은 코드의 스냅샷입니다. "이 시점의 코드를 저장해둬"라는 의미입니다.
...
브랜치(branch)는 독립된 작업 공간입니다. 메인 코드에 영향을 주지 않고 새로운 기능을 개발할 수 있습니다.
...
Pull Request는 "내 코드를 검토하고 합쳐주세요"라는 요청입니다. 팀 협업의 핵심 기능입니다.
...
<div class="chart-bar" data-highlight="max" data-title="git status가 가장 많이 쓰는 명령어 (주간 평균)" data-labels="git status,git add,git commit,git push,git pull,git log,git branch,git diff" data-values="50,40,35,20,15,12,10,8" data-colors="#009e73,#009e73,#3b82f6,#3b82f6,#f59e0b,#94a3b8,#94a3b8,#94a3b8" data-unit="회"></div>
...
오늘 배운 6단계를 순서대로 따라해보세요. 첫 커밋을 하는 순간, Git의 매력에 빠지게 될 것입니다!
