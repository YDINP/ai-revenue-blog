...
<div class="chart-progress" data-title="실시간 성능이 만족도 가장 높은 항목 (2026년)" data-labels="실시간 성능,보안,개발자경험,가격" data-values="94,92,88,85" data-colors="#009e73,#3b82f6,#f59e0b,#d55e00" data-max="100" data-unit="점"></div>
...
<div class="chart-bar" data-highlight="max" data-title="실시간 동기화 지연이 가장 큰 병목(87ms)" data-labels="RLS오버헤드,데이터베이스 응답시간,실시간동기화지연" data-values="12,28,87" data-colors="#f59e0b,#009e73,#3b82f6" data-unit="ms"></div>
