...
<div class="chart-donut" data-title="무료 채널별 위시리스트 유입 비중 (개념적 예시)" data-labels="숏폼(릴스/틱톡/쇼츠),스팀 넥스트 페스트,커뮤니티(레딧/디스코드),유튜버·스트리머,언론/큐레이터" data-values="34,26,18,14,8" data-colors="#3b82f6,#009e73,#f59e0b,#d55e00,#8b5cf6" data-unit="%"></div>
...
<div class="chart-bar" data-title="무료 채널의 시간 대비 효율 (10점 만점, 개념적 평가)" data-labels="넥스트 페스트,숏폼,레딧 데브로그,스트리머 아웃리치,디스코드 운영" data-values="10,9,7,7,6" data-colors="#009e73,#3b82f6,#d55e00,#8b5cf6,#f59e0b" data-unit="점"></div>
