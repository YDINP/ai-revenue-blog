...
<div class="chart-bar" data-title="Sol Ultra가 Sol보다 벤치마크 3.1%p 높음 (Terminal-Bench 2.1, %)" data-labels="GPT-5.6 Sol,GPT-5.6 Sol Ultra" data-values="88.8,91.9" data-colors="#009e73,#3b82f6" data-unit="%" data-highlight="max"></div>
...
<div class="chart-radar" data-title="성능은 Sol, 가성비는 Luna가 최고 (10점 만점)" data-items='[
  {"name":"Sol","scores":[
...
- [로컬 LLM용 GPU·미니PC 추천](/blog/2026-07-11-review-local-llm-gpu-mini-pc-2026/) — API 과금 대신 로컬로 돌리는 선택지
- [데스크 셋업: 모니터암·스탠딩데스크](/blog/2026-07-12-review-desk-setup-monitor-arm-usb-c-hub-2026/) — 에디터와 에이전트 로그를 동시에 띄우는 배치
- [기계식 키보드 추천](/blog/2026-07-14-review-mechanical-keyboard-recommendation-2026/) — 프롬프트도 결국 타이핑입니다
- [외장 SSD 추천](/blog/2026-07-12-review-external-ssd-recommendation-2026/) — 모델 가중치와 체크포인트 보관용
