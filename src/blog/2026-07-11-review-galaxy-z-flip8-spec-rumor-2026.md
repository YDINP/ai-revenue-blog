...
접는 폰의 대명사가 된 갤럭시 Z 플립. 그 여덟 번째 모델이 곧 베일을 벗습니다. 삼성 갤럭시 언팩이 <span style="font-size:1.3em;font-weight:800">7월 22일</span> 열릴 것이란 관측이 나오면서, Z 플립8을 향한 관심도 뜨거워지고 있어요. "이번엔 뭐가 달라질까?", "지금 7을 살까 8을 기다릴까?" 궁금한 분들을 위해 현재까지의 정보를 정리했습니다. 아래 내용은 공식 발표 전 루머·유출 기반이라는 점 기억하고 봐주세요.

## 1. 공개일 — 7월 22일 언팩이 유력

삼성은 매년 여름·겨울 두 차례 언팩을 엽니다. 폴더블 라인업(Z 플립·Z 폴드)은 통상 여름 언팩의 주인공이죠. 올해는 7월 22일 공개가 유력하게 거론되고 있고, 정식 판매는 그로부터 1~2주 뒤로 예상됩니다.
...
2026년은 폴더블 시장이 뜨거운 해입니다. 삼성이 여름에 Z 플립8을 내놓으면, 가을엔 애플의 첫 폴더블 아이폰이 맞불을 놓을 것으로 관측됩니다.
