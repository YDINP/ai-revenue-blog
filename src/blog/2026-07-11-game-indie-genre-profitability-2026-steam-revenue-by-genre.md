...
<div class="chart-bar" data-title="장르별 매출 중앙값 상대 비교 (궤도 진입 게임 기준, 개념적)" data-labels="팩토리/경영,로그라이크 덱빌더,오픈월드 서바이벌,일반 시뮬,내러티브/퍼즐" data-values="90,72,60,55,35" data-colors="#009e73,#f59e0b,#3b82f6,#8b5cf6,#94a3b8" data-unit=""></div>
...
<div class="chart-versus" data-title="장르 선택: 수익성 vs 경쟁 포화도" data-name-a="팩토리·경영(니치·고지출)" data-name-b="액션·RPG(대형·포화)" data-color-a="#009e73" data-color-b="#d55e00" data-items='[{"label":"매출 중앙값","a":85,"b":70},{"label":"팬 충성도·지출","a":90,"b":55},{"label":"경쟁 여유(낮을수록 포화)","a":70,"b":20},{"label":"인디 승산","a":80,"b":35}]'></div>
