...
<div class="chart-bar" data-title="구독 인프라 부담: 직접 구현 vs 도구 활용 (참고용, 낮을수록 좋음)" data-labels="영수증 검증,크로스플랫폼 동기화,환불 처리,분석 구축" data-values="9,10,8,7" data-colors="#3b82f6,#10b981,#f59e0b,#8b5cf6" data-unit="점"></div>
