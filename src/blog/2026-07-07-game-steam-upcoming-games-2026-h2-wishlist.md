...
어쌔신 크리드: 블랙 플래그 리싱크드는 해양 항해와 해적 전투로 팬들의 사랑을 받았던 오리지널(2013)의 현세대 리마스터다. 그래픽 업스케일링과 조작 QoL 개선이 핵심으로, 시리즈 입문자에게도 추천할 만한 타이틀이다. 에코스 오브 아인크라드는 오픈 베타 이후 꾸준한 관심을 받아온 MMORPG로, 원작 애니메이션 팬층의 기대가 높다.
...
<div class="chart-donut" data-title="액션/RPG 장르가 기대 비중 30%로 최다 (개념적 예시)" data-labels="액션/RPG,생존/서바이벌,전략,인디,공포" data-values="30,22,20,18,10" data-colors="#3b82f6,#009e73,#f59e0b,#d55e00,#8b5cf6" data-unit="%"></div>
